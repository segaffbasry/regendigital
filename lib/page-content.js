...
export const pageContent = {
  ...
  "/services/creator-partnerships": service(
    ...
    [["How do you pick the right creators?", "By credibility and audience fit, vetting every voice for genuine alignment."], ["What is the difference between Creator Partnerships and Canvas UGC?", "Creator Partnerships are one-to-one relationships with specific creators chosen for your audience. Canvas UGC is built for tech businesses and features your business across 15–30 creator accounts, for repeated exposure over a campaign of 30 days or more."],["How is this different from founder-led marketing?", "Founder-led builds your own voice; creator partnerships borrow the trust of voices your market follows."], ["Does it really work in B2B?", "A trusted industry voice can move a specific buying audience in a way broad advertising cannot."], ["How do you measure success?", "On engagement, trust, and pipeline with the right audience, not follower numbers."]]
  ),
};
...
const servicePageEnhancements = {
  ...
  "/services/creator-partnerships": {
    ...
    openingId: "creator-partnerships",
    serviceMasthead: {
      index: "01",
      title: "Creator Partnerships",
      tagline: "One-to-one relationships with creators relevant to your audience and brand.",
    },
    includedKicker: "Creator Partnerships: what's included",
    serviceSplit: [
      {
        id: "creator-partnerships",
        label: "Creator Partnerships",
        summary: "One-to-one creator relationships.",
        detail: "Work with specific creators who are relevant to your audience and brand.",
      },
      {
        id: "canvas-ugc",
        label: "Canvas UGC",
        summary: "High-volume creator exposure for tech businesses.",
        detail: "Get your business featured consistently across multiple creator accounts and audiences.",
      },
    ],
    canvas: {
      id: "canvas-ugc",
      index: "02",
      title: "Canvas UGC",
      tagline: "A separate, higher-volume creator service built for tech businesses.",
      headline: "Get your tech business talked about",
      headlineEmphasis: "by multiple creators.",
      paragraphs: [
        "Canvas UGC is a creator platform built specifically for tech businesses. We work with 15–30 creators consistently, each creating content designed to introduce people to the businesses and products featured on the platform.",
        "Rather than relying on one creator or one campaign, your business is featured across multiple creator accounts, giving you repeated exposure from different people and creating the impression of a wider conversation around your brand.",
        "Campaigns can run from 30 days, giving you a consistent stream of creator-led content and visibility.",
      ],
      stats: [
        { value: "15–30", label: "Creators" },
        { value: "Tech", label: "Businesses", detail: "Built specifically for the tech sector" },
        { value: "30+ days", label: "Campaign length" },
      ],
      videosTitle: "See Canvas UGC",
      videosTitleEmphasis: "in action.",
      videosIntro: "See how tech businesses can show up across multiple creator channels at once.",
      videos: [1, 2, 3, 4, 5].map((n) => ({
        src: `/videos/canvas/canvas-ugc-${n}.mp4`,
        poster: `/videos/canvas/canvas-ugc-${n}.jpg`,
        label: `Canvas UGC creator video ${n}`,
      })),
    },
  },
};
...
const industryData = {
  tech: ["Tech Marketing Agency | Regen", "A tech marketing agency for B2B technology companies whose growth has outpaced their marketing.", "B2B Marketing for Innovative Tech Companies.", "Tech Marketing Agency", "Regen is a tech marketing agency for B2B technology companies in SaaS, AI, and tech.", "The product works and the business is scaling, but the marketing has not kept pace. We fix the foundations, sharpen the positioning, and build a strategy that lasts. Then we turn your technical strength into a clear commercial story and a connected marketing system that creates pipeline.", ["A strategy that matches the stage you are actually at", "Positioning that makes a technical proposition commercially clear", "An honest read on what past activity delivered", "A joined-up system across content, search, paid, and ABM", "A long-term partner who keeps optimising as you scale"], ["What does a tech marketing agency do?", "It turns a technical product into a clear commercial story, then builds the marketing that makes buyers act on it, all measured against pipeline and revenue."], [
      ["What makes Regen different from a generalist agency?", "We focus on B2B technical categories and lead with strategy and positioning, not channel output."],
      ["Do you only work with large tech companies?", "No. We work with technology businesses whose growth has outpaced their marketing, from scaling startups to established companies."],
      ["We have tried marketing tactics before that did not work. Can you help?", "Yes. We start by looking at what was tried and why it stalled, then build a strategy designed to last rather than another one-off experiment."],
      ["How is this different from your SaaS and AI pages?", "Same strategy-led approach, tuned to each category. Tech is the parent, SaaS and AI are the specialisms within it where we have the deepest track record."],
      ["How do you measure success?", "On pipeline, revenue, and the commercial outcomes that matter, not activity or vanity numbers."],
    ]],
  saas: ["Marketing Agency for SaaS | Regen", "A marketing agency for SaaS built around recurring revenue, buying committees, and retention.", "Marketing Built for How SaaS Actually Gets Bought.", "Marketing Agency for SaaS", "Regen is a marketing agency for SaaS companies, built around recurring revenue, the right accounts, and retention.", "SaaS growth comes from reaching the right accounts with a reason to choose you that works for everyone involved, then keeping them. We build around how your product is actually bought, connecting positioning, content, and demand into one system for recurring revenue and predictable pipeline.", ["Positioning for the way your product is bought", "Content that earns trust and drives demand", "ABM aimed at your highest-value accounts", "Demand and lead generation that builds pipeline", "Reporting tied to pipeline, acquisition cost, and retention"], ["What does a SaaS marketing agency do?", "It builds strategy and channels around how software is bought and kept, measured on recurring revenue and pipeline."], [
      ["Do you do demand and lead generation as well as content?", "Yes. Content builds the trust, demand and lead generation turn it into pipeline, and they run as one system."],
      ["Do you only work with enterprise SaaS?", "No. We work with SaaS businesses across stages and deal sizes, and we build the strategy around how your product is bought."],
      ["How do you help with retention, not just acquisition?", "Retention is built into the strategy from the start, because for SaaS the value is in keeping customers, not just winning them."],
      ["How soon will we see results?", "Positioning and quick-turn channels move early, while compounding channels like content and SEO build over a few months and keep growing."],
      ["How do you measure SaaS marketing?", "Against pipeline, customer acquisition cost, and retention, not reach or impressions."],
    ]],
  ai: ["Marketing Agency for AI Companies | Regen", "A marketing agency for AI companies that have outgrown ‘we do AI’. We make the commercial value clear.", "Marketing for AI Companies That Need to Build Demand.", "Marketing Agency for AI Companies", "Regen is a marketing agency for AI companies, helping AI startups and scale-ups turn a fast-moving technical proposition into a clear commercial story.", "The category moves weekly and buyers are drowning in lookalike claims. We position what makes you worth choosing, build demand around it, and make sure you appear when buyers ask AI tools for recommendations.", ["Positioning that cuts through a fast-moving category", "Messaging that translates technical depth into value", "Demand through the channels buyers use", "Founder-led marketing to build trust fast", "GEO, so you show up in AI recommendations"], ["How do you market an AI startup?", "Lead with the commercial outcome, not the model. We build positioning first, then the demand around it."], [
      ["Why does an AI company need a specialist marketing partner?", "Because the category is noisy and low-trust, and generic marketing sells the category rather than the reason to choose you. Positioning is the difference."],
      ["Where do AI buyers actually look?", "Increasingly they ask AI assistants and follow credible founders, which is why founder-led marketing and GEO matter as much as traditional channels here."],
      ["Do you work with early-stage AI startups?", "Yes, from pre-investment through to scale-up. We meet you at the stage you are actually at."],
      ["How do you make an AI product understandable to buyers?", "By translating technical depth into the commercial outcome it delivers, and testing that message with the market rather than assuming it."],
      ["How do you measure success?", "On positioning that lands, demand created, and pipeline, plus how often your brand shows up when buyers ask AI tools for recommendations."],
    ]],
  "professional-services": ["Professional Services Marketing Agency | Regen", "A professional services marketing agency for firms in legal, construction, and manufacturing.", "Marketing for Firms Whose Reputation Is Built on Judgement.", "Professional Services Marketing Agency", "Regen is a professional services marketing agency for firms in legal, construction, and manufacturing, where the value sits in judgement, track record, and trust.", "These services are bought through long, considered decisions involving several stakeholders. Most marketing sells the category instead of the judgement, track record, and trust that set one firm apart. We make that difference impossible to miss.", ["Positioning that sells your judgement", "Messaging built for a multi-stakeholder decision", "Content and thought leadership that build trust", "Demand across search, social, and founder-led marketing", "A long-term partner who understands how your firm wins work"], ["How is professional services marketing different?", "It sells judgement, track record, and trust rather than a feature list, using positioning and authority content to make the right firm clear."], [
      ["Which professional services do you work with?", "Firms in legal, construction, and manufacturing, sectors where the value is real but hard to communicate, and the sale is considered and multi-stakeholder."],
      ["Do you have dedicated pages for my sector?", "We are building sector-specific pages for law firms, construction, and manufacturing. In the meantime this page covers all three."],
      ["Why do professional services firms need specialist marketing?", "Because generic marketing sells the category rather than the judgement and track record that actually win work, which is exactly where we focus."],
      ["Is marketing really worth it in a referral-led sector?", "Yes. Strong positioning and authority content make you the obvious choice even when a referral or search kicks off the decision."],
      ["How do you measure success?", "On visibility, credibility, and the enquiries and pipeline that turn into won work."],
    ]],
};
...
const industryEnhancements = {
  saas: {
      ...
      cards: [
        {
          ...
          copy: "Acquisition costs have risen around 60% in five years. Spending your way to growth won't work, you need marketing that brings your cost per customer down.",
    ...
    videoIntro: {
      titleLead: "How ",
      titleEmphasis: "Regen helps SaaS",
      titleTail: " businesses",
      copy: "SaaS growth comes from reaching the right accounts with a reason to choose you that works for everyone involved, then keeping them. We build around how your product is actually bought, connecting positioning, content, and demand into one system for recurring revenue and predictable pipeline.",
    },
    industryRealities: {
  ...
  "professional-services": {
    hero: "Marketing for Professional Services Who Need to Build Trust.",
      ...
      cards: [
        {
          ...
          copy: "Only 15% of decision-makers rate the thought leadership they read as good. Most firms fail to make their expertise clear, so buyers can't tell them apart.",
        ...
        },
        {
          ...
          copy: "75% of buyers say thought leadership led them to a firm they weren't considering, and 60% will pay a premium for it. Expert content wins work.",
          source: "LinkedIn/Edelman",
        },
      ],
    },
      ...
      cards: [
        {
          ...
          copy: "A typical tech purchase runs through 6 to 10 decision-makers. Your message has to land with everyone in the room, which takes research and consideration.",
          source: "Gartner",
        },
        {
          visual: "tech-spend",
          heading: "Spending is surging",
          copy: "Worldwide IT spending will hit $6.37 trillion in 2026, up 14.2%. The budgets are there, but so are the competitors. Being the obvious choice matters.",
          source: "Gartner, 2026",
        },
        {
          visual: "tech-budget",
      ...
      cards: [
        {
          ...
          copy: "58% of buyers now dig into how AI is actually built into a product before they'll engage. Prove your value clearly and you get pulled into deals sooner.",
          source: "6sense, 2025",
        },
        {
          visual: "ai-market",
...
pageContent["/investors"] = {
  title: "Portfolio Marketing Partner for Investors | Regen",
  description: "The B2B marketing partner you can install across the whole portfolio. Strategy, positioning, and delivery for SaaS, AI, and tech companies, reported in a way the fund can use.",
  hero: "The Marketing Partner You Can Bring to the Whole Portfolio.",
  h1: "Portfolio Marketing Partner for Investors",
  section: "Industries",
  tone: "bone",
  industryKey: "investors",
  accentWord: "Portfolio",
  accentColor: "#0028fa",
  entity: "A portfolio-wide marketing partner for investors and the B2B companies they back.",
  heroBody: "Most portfolios end up with a different agency in every company, a different story in every deck, and no shared view of whether marketing is working. Regen is the partner you can bring across the portfolio: strategy and positioning for each company, and a reporting line the fund can use.",
  body: "Strong products stall when the market cannot see why to choose them. Regen gives portfolio companies a clear commercial story, the strategy to take it to market, and a connected marketing system that supports growth and the next round.",
  showIncludedWithRealities: true,
  listTitle: "When to bring us in",
  includedTitle: { lead: "The right moment", emphasis: "to start." },
  included: [
    "A strong product is hard for the market to understand.",
    "Growth has outpaced the marketing around it.",
    "A founder is briefing and chasing an agency instead of running the company.",
  ...
  ctaHref: "/investors/partnership-call",
  ctaHeading: "Ready to put one partner across the portfolio?",
  ctaBody: "A conversation about where the portfolio needs marketing support, which companies first, and whether a shared relationship would help.",
};

/* Investors takes the same industry-detail layout as the other pages, without
   a second intro section after the hero. */
pageContent["/investors"].partnershipHow = {
  title: "How the partnership works",
  items: [
    {
      number: "01",
      title: "Start with the company",
      copy: "You point us at a portfolio company that needs marketing support. We meet the founder, learn the product and stage, and agree what “better” looks like commercially.",
    },
    {
      number: "02",
      title: "Build the system",
      copy: "Positioning first, then the channels that fit. Strategy and delivery stay connected, so the founder is not managing another agency. This is how we work with funded companies like IntusHQ.",
    },
    {
      number: "03",
      title: "Keep everyone clear",
      copy: "The company gets senior support. You get a simple read on progress, risk, and the next move, without sitting in every briefing.",
    },
  ],
};

pageContent["/investors"].industryRealities = {
  title: "Marketing built around the realities of portfolio companies",
  items: [
    {
      heading: "Different companies, one partner",
      copy: "Each company keeps its own story and stage. The fund gets one way of working, so quality does not depend on whoever the founder found last quarter.",
    },
    {
      heading: "A story that can carry a round",
      copy: "Buyers and future investors both need to understand why this company wins. We make that commercial story clear before the channels spend against it.",
    },
    {
      heading: "Founders should not run an agency",
      copy: "When growth outpaces marketing, the founder ends up briefing, chasing, and translating. We take that off them and keep the fund in view.",
    },
    {
      heading: "Built for SaaS, AI, and tech",
      copy: "Complex products, considered sales, more than one buyer. That is the work we do, not a sideline we stretch into.",
    },
    {
      heading: "Reporting the fund can use",
      copy: "Updates cover progress, risk, and the next commercial move. Enough to see which companies are in shape and which need attention.",
    },
    {
      heading: "Stage-aware support",
      copy: "Pre-seed and Series B do not need the same system. We match the work to the company, with a shared standard behind it.",
    },
  ],
};

pageContent["/investors"].faqs = [
  [
    "Do you work with the fund or the portfolio company?",
    "Usually with the company. An investor can introduce us, join the first call, and stay in the loop. The day-to-day sits with the founder and operators.",
  ],
  [
    "Have you worked with investment funds before?",
    "We already support funded B2B companies and we are set up for investors who want a trusted partner they can send companies to.",
  ],
  [
    "Which companies are the best fit?",
    "B2B SaaS, AI, and tech businesses where the product is strong, the sale is considered, and marketing has not kept up with growth or the next round.",
  ],
  [
    "What does an engagement look like?",
    "We start with auditing a company, positioning and strategy first, then the channels that fit the next stage. The next stage can be anything from organic strategy, paid ads, building pipeline or consulting.",
  ],
  [
    "Do you replace an in-house marketing team?",
    "No. Where a team exists, we give them strategy and specialist delivery they cannot build alone. Where it does not, we cover the gap until the company is ready to hire.",
  ],
  [
  ...
  [
    "What happens on the partnership call?",
    "Thirty minutes with the Regen founders. We talk about the company (or companies) you have in mind, what is stuck, and whether we are the right partner.",
  ],
  [
    "How do you measure progress?",
    "Against the commercial goal for that company, clarity of the story, demand where the work has reached that stage, and a clear next move.",
  ],
];
...
pageContent["/work/agency-ai"] = {
  title: "Agency AI Case Study | Regen",
  description: "How Regen built an outbound engine and grew qualified traffic for AI automation consultancy Agency AI.",
  openGraph: {
    title: "Agency AI Case Study | Regen",
    description: "How Regen built an outbound engine and grew qualified traffic for AI automation consultancy Agency AI.",
    type: "article",
    url: "/work/agency-ai",
    images: ["/client-logos/client-04.png"],
  },
  section: "Case Study",
  caseStudy: {
    client: "Agency AI",
    headline: "How Regen Built an Outbound Engine and Grew Qualified Traffic for AI Automation Company Agency AI",
    headlineEmphasis: "Outbound Engine",
    quote: {
      text: "What sets them apart is that they operate as a genuine strategic partner, not an external agency.",
      name: "Max Modlin",
      role: "Founder, Agency AI",
      image: "/testimonials/max-modlin.webp",
    },
    about: [
      "Agency AI is an AI and automation consultancy based in Glasgow, Scotland. Founded by Max Modlin in 2024, it helps businesses put AI and automation into practice, turning pilots into working systems rather than stuck experiments.",
      "Max spent over twelve years in enterprise tech, holding Director and VP roles at major banks, before starting the consultancy. He recently partnered with Regen and is now a dedicated partner, helping to implement AI builds within the business.",
    ],
    challengeIntro: "Agency AI needed a repeatable way to fill the pipeline, not just a stream of one-off interest. Three gaps stood in the way.",
    challengeHeading: { lead: "A strong offer.", emphasis: "No repeatable pipeline." },
    challenges: [
      {
        title: "Referrals alone would not scale pipeline",
        body: "Organic content was generating inbound interest, but Agency AI needed a more predictable, repeatable source of qualified conversations to support growth targets, rather than relying on organic reach and referrals. The website was also not set up to capture demand: no SEO or keyword structure, and no gated assets to turn visitors into known leads.",
      },
      {
        title: "No systematic sales motion",
        body: "There was no structured sales motion reaching the ideal customer profile directly. Agency AI needed a way to start conversations with the right people at scale, tracked and measurable, without pulling founder time away from product and delivery.",
      },
      {
        title: "Reaching the right demographic",
        body: "Growth depended on reaching buyers in the target markets: the United States and United Kingdom. Activity needed to concentrate on those geographies and show measurable movement in the right audiences.",
      },
    ],
    approachIntro: "Regen ran an ecosystem approach: organic content as the always-on base, a stronger website with gated assets to capture demand, and a dedicated sales system on top. Paid search is now being layered in to amplify. Insight from one channel feeds the others.",
    approachHeading: { lead: "One connected", emphasis: "growth engine." },
    approach: [
      {
        title: "Organic content (the base)",
        body: "Consistent organic content built visibility and authority, and generated qualified inbounds over the engagement. It established the foundation the rest of the engine now builds on, and social now feeds real conversations into the pipeline.",
      },
      {
        title: "SEO, keyword and website",
        body: "Worked with Agency AI on an SEO and keyword-driven website so the right buyers can actually find them. Built gated assets, including an ebook, to capture demand and turn anonymous visits into known leads.",
      },
      {
        title: "A dedicated sales system",
        body: "Built a system that starts conversations with the right people directly. It is live and working in the background, generating qualified conversations without adding to the founder's workload.",
      },
      {
        title: "Paid search (kicking off)",
        body: "Now layering in paid search to amplify the same targeting and messaging, closing the loop from organic through to paid.",
      },
      {
        title: "Compounding effect on website traffic",
        body: "Over the same 30-day window in which the sales system went live, the site showed a clear lift in traffic, with referral traffic and new users climbing and the United States and United Kingdom leading the geographies, matching the target demographic.",
      },
    ],
    resultsIntro: "Traffic and new-user growth moved in the right direction, while engagement and profile views kept climbing and content translated directly into booked appointments.",
    resultsHeading: { lead: "Momentum you", emphasis: "can measure." },
    results: [
      { value: "+15%", label: "referral traffic in the first 30 days" },
      { value: "+14%", label: "month-on-month growth in new users" },
      { value: "Climbing", label: "engagement and profile views, month on month" },
      { value: "Booked", label: "appointments secured directly off the back of content" },
    ],
    closing: "Beyond the traffic, the work is compounding. Engagement and profile views are climbing month on month, and social is feeding real conversations into the pipeline. A dedicated sales system is now running quietly in the background, starting the right conversations with the right people, with paid search being layered in to amplify.",
    nextHeading: { lead: "Ready to build a system", emphasis: "that compounds?" },
  },
};

pageContent["/work/intushq"] = {
  title: "IntusHQ Case Study | Regen",
  description: "How Regen put IntusHQ in front of 5x more of the right buyers with strategy, account-based marketing, organic social and a founder-led profile.",
  openGraph: {
    title: "IntusHQ Case Study | Regen",
    description: "How Regen put IntusHQ in front of 5x more of the right buyers with strategy, account-based marketing, organic social and a founder-led profile.",
    type: "article",
    url: "/work/intushq",
    images: ["/IntusHQ/intushq-cover.png"],
  },
  section: "Case Study",
  caseStudy: {
    client: "IntusHQ",
    headline: "How Regen put IntusHQ in front of 5x more of the right buyers",
    headlineEmphasis: "5x more",
    about: [
      "IntusHQ is an inventory management platform for UHNW families, their family offices, and the teams who run their estates or yachts. It brings every tangible asset a family owns across property, yachts, aircraft, and collections into 1 secure system.",
      "Founder Katy Jeffcoate spent 25 years inside the industry before building the product to fix what she kept watching go wrong.",
    ],
    challengeHeading: { lead: "A clear point of view.", emphasis: "Nothing pointing at it." },
    challenges: [
      {
        title: "Limited brand visibility in target markets",
        body: "IntusHQ had a platform and a clear point of view, and nothing pointing at it. No content, no outbound, no visible founder presence. Prospects who went looking found a company that was hard to verify, which is a serious problem in a market that runs entirely on trust and discretion.",
      },
      {
        title: "Investment had just landed",
        body: "Having secured funding, IntusHQ needed to show commercial traction quickly. That meant building a marketing function from nothing, at pace.",
      },
    ],
    approachHeading: { lead: "Built on the trust", emphasis: "she already had." },
    approach: [
      {
        title: "Marketing strategy and consultancy",
        body: "We started by mapping their 4 buyer types, looking at what each one actually loses when their inventory is undocumented. That reframed the whole proposition around loss rather than features, and it gave every channel a shared argument to work from. We also benchmarked IntusHQ against the competitors, covering positioning, messaging, and where each one was visible, to find the ground nobody had claimed. We continue to advise on positioning, general marketing, and competitive strategy as the business grows.",
      },
      {
        title: "Account-based marketing",
        body: "Katy was in a rare position for a founder. After 25 years in the industry, her own LinkedIn network was already full of the people IntusHQ needed to reach, so we started there rather than building a cold list. Warm contacts who already recognise the name close faster and with far less resistance. We built and segmented a target account list, then ran LinkedIn outbound against it.",
      },
      {
        title: "Organic social media content",
        body: "People check a company page before they take a meeting, and in this market they check it carefully. A dormant page tells a prospect you might not be around in 2 years, which is a real risk when you are asking them to move decades of records into your system. We built the business account to do 2 jobs. Make IntusHQ visible to the right people, and make it credible when they arrive.",
      },
      {
        title: "Founder profile",
        body: "In this market a founder who has run these estates carries more weight than any brand account. We build Katy's personal presence around her own point of view on the industry, the things 25 years taught her that nobody else is saying out loud, and the reality of building the company as it happens. Building in public earns trust in a way polished brand messaging cannot, particularly with buyers who are wary of being sold to.",
      },
    ],
    resultsHeading: { lead: "In front of the", emphasis: "right buyers." },
    results: [
      { value: "5x", label: "more of the target audience reached" },
      { value: "17.5%", label: "engagement rate, up from 6.2%" },
      { value: "85%", label: "of LinkedIn page visits came from manager level or above" },
    ],
    nextHeading: { lead: "Ready to be seen by", emphasis: "the right buyers?" },
  },
};
...
pageContent["/work/finden"] = {
  title: "Finden Case Study | Regen",
  description: "How Regen ran a go-to-market relaunch for AI workspace Finden and grew landing page views by 511% on a lean media budget.",
  openGraph: {
    title: "Finden Case Study | Regen",
    description: "How Regen ran a go-to-market relaunch for AI workspace Finden and grew landing page views by 511% on a lean media budget.",
    type: "article",
    url: "/work/finden",
    images: ["/pics/ChatGPT Image Jul 31, 2026, 10_27_29 AM.png"],
  },
  section: "Case Study",
  caseStudy: {
    client: "Finden",
    headline: "How Regen Ran a Go-to-Market Relaunch and Grew Landing Page Views by 511% for AI Workspace Finden",
    headlineEmphasis: "511%",
    quote: {
      text: "From day one, Regen approached our brand with the same care and urgency as an in-house team.",
      name: "Randeep Wilkhu",
      role: "Founder, Finden",
      image: "/testimonials/randeep-wilkhu.jpg",
    },
    about: [
      "Finden is an AI workspace that unifies, automates, and runs the day to day of a business. It connects the tools a team already works in, then puts an AI agent on top of them, so the operational work that usually sits with a person gets handled in 1 place.",
      "Founder Randeep Wilkhu is a London-based investor and operator with more than 20 years of international experience helping companies grow, expand into new markets, and reach successful exits. He started Finden in 2024 after seeing the same problem everywhere: digital overload, fragmented tools, and too much time lost finding what matters. The product was rebuilt around 1 connected AI workspace that can retrieve context and act on it.",
    ],
    challengeIntro: "Finden was reintroducing itself to a market that had already moved on. The relaunch had to earn attention and convert it inside the same short window. Three gaps stood in the way.",
    challengeHeading: { lead: "A product worth a second look.", emphasis: "Nothing pointing people at it." },
    challenges: [
      {
        title: "A relaunch with no go-to-market behind it",
        body: "The product had been rebuilt and the positioning was clear. What was missing was any way of getting it in front of the operators it was made for. No consistent content, no paid presence, and no launch plan. In a category where every product promises automation, a company with no visible presence does not get shortlisted.",
      },
      {
        title: "One launch moment to get right",
        body: "The Product Hunt debut put Finden up against 280+ companies in a single day, and most of the attention a launch earns is gone within 48 hours. The launch had to do 2 jobs at once: rank high enough to leave behind a credibility marker, and convert the traffic while it was still there.",
      },
      {
        title: "A lean media budget",
        body: "Total ad spend was £1,600 across 3 months. At that level you cannot buy your way to a result, and there is no room to spend a month working out which creative performs. Every pound of media had to sit behind formats that were already proving themselves.",
      },
    ],
    approachIntro: "Regen ran an ecosystem approach: organic content as the always-on base, a launch built to concentrate visibility, creator-led content to earn the click, and paid social to put weight behind whatever proved it worked. What we learned in creative testing fed straight back into the organic output.",
    approachHeading: { lead: "One relaunch,", emphasis: "4 channels pulling together." },
    approach: [
      {
        title: "Organic social (the base)",
        body: "Paid traffic lands on a company, not just a landing page. People click an ad, then check the profile before deciding whether the product is real. We rebuilt the organic base first, so anyone who went looking found a polished, active company that understood their problem and looked like it would still be here in 2 years. That foundation is what made the paid spend worth making.",
      },
      {
        title: "Go-to-market and launch",
        body: "We planned the relaunch to concentrate visibility into the window where attention is free, then convert it, rather than treating the ranking as the outcome. Finden placed 3rd out of more than 280 companies on debut, which gave the brand a credibility marker it could point to in every channel afterwards.",
      },
      {
        title: "Creator partnerships",
        body: "We built the campaigns around a creator-led approach rather than polished product shots. Software buyers discount an ad that looks like an ad, and they trust someone who looks like them showing the thing working. Video outperformed static across every placement, consistently enough that it stopped being a test and became the default.",
      },
      {
        title: "Paid social (Meta)",
        body: "With the organic foundation in place, we layered in a paid Meta strategy across Facebook and Instagram to extend reach and drive direct action. The structure was built to identify the winning creative fast and put the budget behind it, not to spread spend evenly across formats. The best-performing creative reached a 17.20% click-through rate at £0.57 cost per landing page view.",
      },
      {
        title: "Compounding effect on creative",
        body: "Every round of testing narrowed the field. By the end of the 3 months the account was running on a creative format we could prove, at a cost per landing page view well below benchmark, on a budget that had not changed.",
      },
    ],
    resultsIntro: "Landing page views multiplied on flat spend, click-through rates sat well above category benchmarks, and the cost of getting someone onto the page fell to pennies.",
    resultsHeading: { lead: "The right creative,", emphasis: "not a bigger budget." },
    results: [
      { value: "+511%", label: "growth in landing page views" },
      { value: "4.24%", label: "average click-through rate across Meta" },
      { value: "£0.57", label: "cost per landing page view" },
      { value: "3rd", label: "out of 280+ companies on launch day" },
    ],
    closing: "Beyond the numbers, the relaunch left Finden with something reusable. The launch produced a credibility marker, the creative testing produced a format that works, and the organic base is still running underneath both. The next round of spend starts from proof rather than from guesswork.",
    nextHeading: { lead: "Ready to relaunch into a market", emphasis: "that is actually listening?" },
  },
};
...
pageContent["/privacy-policy"] = {
  ...
  description: "How Regen Digital collects, uses and protects personal information when you visit our website or contact us.",
};
