...
const servicePageEnhancements = {
  ...
  "/services/geo": {
    ...
    insightImage: "/pics/service-seo.webp",
  ...
  "/services/paid-social": {
    ...
    includedDetails: [
      "Every platform, audience, and pound gets a clear role before the campaign goes live.",
    ...
    insightImage: "/pics/service-paid-social.webp",
  ...
  "/services/marketing-strategy-consultancy": {
    ...
    openingTitle: "Why strategy is worth it for B2B",
    openingTitleEmphasis: "strategy is worth it",
    includedDetails: [
  ...
  "/services/organic-social": {
    ...
    insightImage: "/pics/creator-partnerships.png",
    insightImageAlt: "An overhead view of a team working across laptops and mobile devices.",
  },
  "/services/account-based-marketing": {
    ...
    insightImage: "/pics/service-abm.webp",
    insightImageAlt: "A strategist researching across a laptop, phones, and printed material.",
  },
  "/services/go-to-market-and-launch": {
    heroPill: "The Go-to-Market and Product Launch Agency",
    heroEmphasis: "Impossible to Ignore.",
    openingTitle: "Why go-to-market strategy is worth it for B2B",
    openingTitleEmphasis: "go-to-market strategy is worth it",
    includedDetails: [
...
const industryMarks = {
  ...
  "professional-services": { accentWord: "Judgement", accentColor: "#0028fa" },
};
...
pageContent["/how-we-work"] = { title: "How We Work | Regen", description: "A long-term B2B growth partnership, not a one-channel supplier. How the engagement runs, who it is for, and who it is not for." };
