...
pageContent["/work/finden"] = {
  ...
  caseStudy: {
    ...
    media: {
      feature: [
        {
          src: "/pics/ChatGPT Image Jul 31, 2026, 10_27_29 AM.png",
          alt: "A fast-moving work session across a laptop, tablet, and phone.",
        },
      ],
      gallery: [
        {
          src: "/pics/_ (1) 1.png",
          alt: "A business owner working across a laptop, phone, and printed materials.",
        },
        {
          src: "/pics/_ (2) 1.png",
          alt: "A connected creative workspace with a desktop computer and working materials.",
        },
      ],
    },
