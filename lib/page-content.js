      ...
      cards: [
        {
          ...
          copy: "Acquisition costs have risen around 60% in five years. Spending your way to growth no longer works, you need marketing that brings your cost per customer down.",
      ...
      cards: [
        {
          ...
          copy: "Only 15% of decision-makers rate the thought leadership they read as very good. Most firms fail to make their expertise clear, so buyers can't tell them apart.",
        ...
        },
        {
          ...
          copy: "75% of buyers say thought leadership led them to a firm they weren't considering, and 60% will pay a premium for it. Expert content wins work you'd never otherwise reach.",
          source: "LinkedIn/Edelman",
        },
      ],
    },
      ...
      cards: [
        {
          ...
          copy: "A typical tech purchase runs through 6 to 10 decision-makers. Your message has to land with everyone in the room, which takes deliberate research and consideration.",
          source: "Gartner",
        },
        {
          visual: "tech-spend",
          heading: "Spending is surging",
          copy: "Worldwide IT spending will hit $6.37 trillion in 2026, up 14.2%. The budgets are there, but so are the competitors, so being the obvious choice matters more than ever.",
          source: "Gartner, 2026",
        },
        {
          visual: "tech-budget",
...
/* Investors takes the same second section as the industry pages. Its title is
   set here rather than derived, since the pattern the others use would read as
   "How Regen helps Portfolio businesses". */
pageContent["/investors"].videoIntro = {
  titleLead: "How ",
  titleEmphasis: "Regen helps investors",
  titleTail: "",
  copy: "Investment teams see the same pattern: a product that works, a market that does not understand it, and a founder managing marketing in the gaps. We put senior strategy and delivery inside the companies that need it, and give the fund a clear view of progress, risk, and the next commercial move.",
};
